...
"""This is the function that runs simulations
   ...
   mechanical_control_animation are executed. If the
...
def create_animation():
    ...
    if checkValidity(user_floors, user_lifts)[0] == True:
        ...
        from mechanical_control_animation import (create_sides, create_floors,
                                                  create_multiple_elevators, create_people,
...
configuration_window.title("Mechanical Control System Configuration")
